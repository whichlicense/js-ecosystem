...
publishing {
    publications {
        create<MavenPublication>("yarn") {
            ...
            pom {
                name.set("WhichLicense js-ecosystem/yarn")
                description.set("This library provides a yarn focused MetadataSeeker implementation.")
                url.set("https://github.com/whichlicense/js-ecosystem/yarn")
                licenses {
                    license {
...
signing {
    if (project.hasProperty("CI")) {
        ...
        sign(publishing.publications["yarn"])
    }
}
