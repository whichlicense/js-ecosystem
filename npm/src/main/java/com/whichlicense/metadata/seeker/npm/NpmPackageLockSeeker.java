...
/**
 * A concrete implementation of the MetadataSeeker interface that seeks for package-lock.json files.
 *
 * @author David Greven
 * @version 0
 * @since 0.0.0
 */
public record NpmPackageLockSeeker() implements MetadataSeeker {
    /**
     * Returns a singleton set of the package-lock.json glob pattern.
     *
    ...
    public Set<String> globs() {
        return Collections.singleton("**/package-lock.json");
    }
